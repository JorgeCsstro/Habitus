...
-- ========================================
-- 2. TABLES WITH SINGLE FOREIGN KEY DEPENDENCIES
-- ========================================

-- Table structure for table `tasks` (depends on users, task_types)
...
-- Table structure for table `rooms` (depends on users)
...
-- Table structure for table `shop_items` (depends on item_categories)
...
CREATE TABLE `shop_items` (
  ...
  `allowed_surfaces` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'floor' COMMENT 'Comma-separated list of allowed surfaces for this item',
...
-- Table structure for table `dashboard_layouts` (depends on users)
...
-- Table structure for table `notifications` (depends on users)
...
-- Table structure for table `subscription_history` (depends on users)
...
-- Table structure for table `transactions` (depends on users)
...
-- Table structure for table `user_inventory` (depends on users, shop_items)
...
-- ========================================
-- 3. TASK-RELATED TABLES (depend on tasks)
-- ========================================

-- Table structure for table `dailies` (depends on tasks)
...
-- Table structure for table `challenges` (depends on tasks)
...
-- Table structure for table `goals` (depends on tasks)
...
-- Table structure for table `subtasks` (depends on tasks)
...
-- ========================================
-- 4. COMPLEX TABLES (multiple foreign keys)
-- ========================================

-- Table structure for table `placed_items` (depends on rooms, user_inventory)
DROP TABLE IF EXISTS `placed_items`;
CREATE TABLE `placed_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `room_id` int NOT NULL,
  `inventory_id` int NOT NULL,
  `surface` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'floor' COMMENT 'Surface where item is placed: floor, wall-left, or wall-right',
...
-- Insert data for item_categories
...
-- Insert data for subscription_plans
...
-- Insert data for user_inventory
...
-- Dump completed on 2025-05-30  0:59:06